...
class PasswordConfirmation extends Component
{
    ...
    {
        $this->message = $message ?? __('hearth-components::auth.confirm_intro');

        $this->cancel = $cancel ?? __('hearth-components::auth.action_cancel');

        $this->confirm = $confirm ?? __('hearth-components::auth.action_confirm');
    }
