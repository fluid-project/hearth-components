const confirmPassword = (
	confirmedPasswordStatusRoute = false,
	confirmPasswordRoute = false,
) => ({
	routes: {
	...
	init() {
		window.axios.get(this.routes.confirmedPasswordStatus).then((response) => {
...
window.Alpine.data("confirmPassword", confirmPassword);
